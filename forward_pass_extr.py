...
from model import SpatialExtractor, TemporalExtractor, SpatialExtractorDeiT, SpatialExtractorTest
...
OUTPUT_DIR = PROJ_DIR + r'\output_features15_main_cnn2'
BATCH_SIZE = 16
...
spatial_extractor = SpatialExtractorTest()
...
for i in range(0, train_count):
    ...
    for idx, image in enumerate(train_images):
        extracted_feature = spatial_extractor.predict(np.expand_dims(image, axis=0))

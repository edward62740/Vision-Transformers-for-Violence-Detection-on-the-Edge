...
train_labels = np.load(PROJ_DIR + r'/output_features15_main_cnn2/train_lbl.npy', allow_pickle=True)
train_img_new_idx = np.load(PROJ_DIR + r'/output_features15_main_cnn2/train_images_new_idx.npy', allow_pickle=True)

test_labels = np.load(PROJ_DIR + r'/output_features15_main_cnn2/test_lbl.npy', allow_pickle=True)
test_img_new_idx = np.load(PROJ_DIR + r'/output_features15_main_cnn2/test_images_new_idx.npy', allow_pickle=True)

extracted_features = np.load(PROJ_DIR + r'/output_features15_main_cnn2/train.npy', allow_pickle=True)
extracted_features_test = np.load(PROJ_DIR + r'/output_features15_main_cnn2/test.npy', allow_pickle=True)


classifier_model = TemporalExtractor4()

classifier_model.build(input_shape=[(None, 1), (None, 16, 1280)])  # 16?

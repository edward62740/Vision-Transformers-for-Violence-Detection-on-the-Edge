...
train_labels = np.load(PROJ_DIR + r'/output_features15_deit/train_lbl.npy', allow_pickle=True)
train_img_new_idx = np.load(PROJ_DIR + r'/output_features15_deit/train_images_new_idx.npy', allow_pickle=True)

test_labels = np.load(PROJ_DIR + r'/output_features15_deit/test_lbl.npy', allow_pickle=True)
test_img_new_idx = np.load(PROJ_DIR + r'/output_features15_deit/test_images_new_idx.npy', allow_pickle=True)

extracted_features = np.load(PROJ_DIR + r'/output_features15_deit/train.npy', allow_pickle=True)
extracted_features_test = np.load(PROJ_DIR + r'/output_features15_deit/test.npy', allow_pickle=True)

# output_features15_main_cnn2 works best
classifier_model = TemporalExtractor4()

classifier_model.build(input_shape=[(None, 1), (None, 16, 192)])  # 16?

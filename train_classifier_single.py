...
classifier = keras.layers.Dense(256, activation='relu6', kernel_regularizer=regularizers.l2(0.0001))(classifier)
classifier = keras.layers.Dense(128, activation='relu6', kernel_regularizer=regularizers.l2(0.0001))(classifier)
classifier = keras.layers.Dense(64, activation='relu6', kernel_regularizer=regularizers.l2(0.0001))(classifier)
...
# train the model
model.fit(train_images, train_labels, epochs=30, batch_size=1,
